Using MVC architecture a simple website was created which allows users to select a file from their system and upload it to an Azure Blob Storage account.
